...
contract("SupplyChain", function (accounts) {
  ...
  it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferTwo[4].toNumber(), price, "Error: Wrong Price");
  ...
  it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferOne[2], distributorID, "Error: Invalid owner after buying item");
    assert.equal(resultBufferTwo[5], 4, "Error: Invalid item State");
    assert.equal(resultBufferTwo[6], distributorID, "Error: Invalid distributor id after buying item");
    assert.equal(eventEmitted, true, "Invalid event emitted");
  });
  ...
  it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferOne[2], retailerID, "Error: Invalid owner after buying item");
  ...
  it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
    ...
    // Verify the result set
    assert.equal(resultBufferOne[2], consumerID, "Error: Invalid owner after buying item");
  ...
  it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async () => {
    ...
    // Verify the result set:
    assert.equal(resultBufferTwo[0].toNumber(), sku, "Error: Wrong SKU");
    assert.equal(resultBufferTwo[1].toNumber(), upc, "Error: Wrong UPC");
    assert.equal(resultBufferTwo[2].toNumber(), productID, "Error: Wrong ProductId");
